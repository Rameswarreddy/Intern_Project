...
import Integrating from "./component/Integration/Integrating";
...
const Signup = () => {
  ...
  // Validation***                  
                validationSchema:Yup.object ({
                    ...
                    .max(40,"* please enter must be 8-15 characters *")
                 ...
                 onSubmit:(values)=>{ 
                        integrating.emailValidation(values.email).then((res)=>{
                           if(res.values){ toast.warn("This Email already exists"); }     
