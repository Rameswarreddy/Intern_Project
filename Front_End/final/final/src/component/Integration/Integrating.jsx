...
class Integrating{
    ...
    emailValidation(email){
       return axios.get(REST_API_URL+"/checkUserEmail/{email}"+email) 
    }
...
// EnrollCourse
  ...
  userCourseEntitysaved(student_details){
    return axios.post(REST_API_URL+"/enrolled_students_details",student_details);
  }

  //list of  student details
  listOfAllUsers(studentDetails){
    return axios.get(REST_API_URL+"/all_enrolled_students_details"+studentDetails);
  }
} 